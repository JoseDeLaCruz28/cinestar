const getCine = async () => {
    ...
    const web1 = await fetch(`https://oaemdl.es/cinestar_sweb_php/cines/${id}`)
    if(web1.status == 200) {
    ...
    const web2 = await fetch(`https://oaemdl.es/cinestar_sweb_php/cines/${id}/tarifas`);
    if(web2.status == 200) {
    ...
    const web3 = await fetch(`https://oaemdl.es/cinestar_sweb_php/cines/${id}/peliculas`);
    if(web3.status == 200) {
